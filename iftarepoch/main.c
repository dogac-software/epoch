...
int main() {
    ...
    printf("Gunesin batisini tarih ve saatini girin (YIL(YYYY) AY(AA) GUN(GG) SAAT(SS) DAKIKA(DD) SANIYE(ss): ");
    ...
    printf("Iftara kalan zaman: yil = %d, ay = %d, gun = %d, saat = %d, dakika = %d, saniye = %d\n", 
